...
function ullist() {
    ...
    $.ajax({
            ...
            let hotStr = ''; hotArr.forEach((item, index) => {
                if (item.type == 'text') {
            ...
            hotStr = '<div class="hot">' + hotStr + '</div>'; $('.padding').append(hotStr);
            ...
            let recomStr = ''; recomArr.forEach((item, index) => {
                if (item.type == 'text') {
            ...
            }); recomStr = '<div class="recom">' + recomStr + '</div>'; $('.recommend').append(recomStr);
            ...
            let time_str = ''; time_Arr.forEach(item => {
        ...
        <p class="banner">
            ...
            addDom(Driving_Arr, '.Driving_box') addDom(Sweep_Arr, '.Sweep_box')
            // 智能守护
            ...
            let content_str = ''; content_Arr.forEach(item => {
            ...
            let after_str = ''; after_arr.forEach((item, index) => {
                if (index == 0) {
      ...
      `
            ...
            let help_str = ''; help_arr.forEach((item, index) => {
                if (index == 0) {
